...
typedef struct rpmalloc_interface_t {
	...
	void* (*memory_map)(void *context, size_t size, size_t alignment, size_t* offset, size_t* mapped_size);
	//! Commit a range of memory pages
	void (*memory_commit)(void *context, void* address, size_t size);
	//! Decommit a range of memory pages
	void (*memory_decommit)(void *context, void* address, size_t size);
	...
	void (*memory_unmap)(void *context, void* address, size_t offset, size_t mapped_size);
